...
# import nlp_util
import re
from r2_chatterbot.util import nlp_util
...
def weather(text, parse_location=True):
    ...
    target_words = utils.load_words("r2_chatterbot/data/weather_topic_words.txt")
    time_words = utils.load_words("r2_chatterbot/data/weather_time_words.txt")
...
def restaurant(text, parse_location=True):
    ...
    target_words = utils.load_words("r2_chatterbot/data/restaurant_topic_words.txt")
