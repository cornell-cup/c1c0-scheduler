...
def writeToSerial(writeArray):
	...
	locomotion_API.locomotion_msg('/dev/ttyTHS1', 115200, writeArray) # serial port: /dev/ttyTHS1 USB port: /dev/ttyACM0
...
locomotion_API.locomotion_msg('/dev/ttyTHS1', 115200, data)
