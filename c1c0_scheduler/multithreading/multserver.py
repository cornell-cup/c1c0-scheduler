...
# All processes may kill their own status (standard kill command)
for proc in ProcessTypes:
    proc.value[1]['kill'] = lambda _, __, ___: kill_thread(proc.value[0])
